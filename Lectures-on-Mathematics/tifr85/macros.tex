...
\newcounter{npart}
\setcounter{npart}{1}
\def\thenpart{\Alph{npart}}
\newcounter{nsection}[chapter]
\setcounter{nsection}{0}
...
\newtheorem{jtheorem}{Jensen's Theorem}[section]
\newtheorem{theorem}{Theorem}[section]
\newtheorem{subtheorem}{Theorem}
\def\thesubtheorem{\thechapter.\thesection.\arabic{subtheorem}}

\newtheorem{alphtheorem}{Theorem}
\def\thealphtheorem{\thechapter.\thensection\thenpart.\arabic{alphtheorem}}


\newtheorem{alphlemma}{Lemma}
\def\thealphlemma{\thensection\thenpart.\arabic{alphlemma}}
