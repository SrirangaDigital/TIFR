...
\newtheorem{subdefin}{Definition}[section]
...
\newtheorem{subremarks}{Remarks}[section]
...
\newtheorem{proofofsublemma}{Proof of Lemma}[section]
\newtheorem{proofofprop}{Proof of Proposition}[section]
\newtheorem{proofoftheorem}{Proof of Theorem}[section]
\newtheorem{proofofthm}{Proof of Theorem}[section]
\newtheorem{proofcontd}{Proof continued}[section]
...
\renewcommand\thesubsection{\thesection.\@arabic\c@subsubsection}
...
\newcommand*\house[1]{%
\raisebox{-1.5pt}{\kern -9pt
\tikz[label distance=1mm]\draw[baseline=(C.base),line width=.2mm,inner
  sep=.9pt]  (0,0)  -- (0,.3) node[below]{\kern 11pt $#1$}
-- (.42,.3) -- (.42,0);}}
