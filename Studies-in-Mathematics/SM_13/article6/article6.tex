...
\begin{definition}\label{art6-definition-15.6}
...
\bibitem[B1]{art6-keyB1} A. Borel, \textit{Admissible representations of a semi-simple group over a local field with vectors fixed under an Iwahori subgroup}, Invent. Math. {\bf 35} (1976) 233-259.
\bibitem [B2]{art6-keyB2} A. Borel, \textit{Linear Algebraic Groups}, second enlarger edition, Springer-Verlag, New York (1991).
\bibitem [BW]{art6-keyBW} A. Borel and N. Wallach, \textit{Continuous Cohomology, Discrete Subgroups and Representations of Reductive Groups}, Annals of Mathematics Studies, {\bf 94} Princeton University Press. Princeton, New Jersey (1980) 3-381.
\bibitem[Bo]{art6-keyBo} N, Bourbaki, \'El\'ements de math\'ematique, Fasc. XXXIV, Groupes et Alg\`ebres de Lie, IV, V and VI, Actualit\'es Scientifiques et Industrielles, {\bf 1337} Hermann, Paris (1968).

\bibitem[Br]{art6-keyBr} K.S. Brown, \textit{Buildings}, Springer-Verlag, New York (1989) 1-209.

\bibitem[BTI]{art6-keyBT-I} F. Bruhat and J. Tits, \textit{\'Groupes R\'eductifs sur un Corps Local I. Donn\'ees radicielles valu\'ees} Publ. Math IHES, {\bf 41} (1972) 5-252.

\bibitem[BT II]{art6-keyBT-II}F. Bruhat and J. Tits, \textit{Groupes R\'eductifs sur un Corps Local II. Sch\'emas en groupes. Existence d'une don\'ee radicielle valu\'ee}, Publ. Math. IHES, {\bf 60} (1984) 5-184.

\bibitem[CE]{art6-keyCE} H. Cartan and S. Eilenberg, \textit{Homological Algebra}, Princeton University Press, Princeton, New Jersey (1956).

\bibitem[C]{art6-keyC} P. Cartier, \textit{Representations of $p$-adic groups}, A survey in \textit{Automprphice forms, representatons and $L$-functions $I$}, Proceeding on the Symposium in pure Mathematics, {\bf 33} American Mathematical Society, Providence, Rhode Island (1979) 111-155.

\bibitem [CW]{art6-keyCW} W. Casselman and D. Wigner, \textit{Continuous cohomology and a conjecture of Serre's}, Invent. Math {\bf 25} (1974) 199-211.

\bibitem [Go]{art6-keyGo} R.Godement, \textit{Th\'eorie des faisecaux}, Act. Sci. Ind. {\bf 1252} Hermann, Paris (1958)

\bibitem [MGI]{art6-keyMG-I} M. J. Greenberg, \textit{Schemata over local rings}, Ann. Math {\bf 73} (1961) 624-648.

\bibitem [MG II]{art6-keyMG II} M . J. Greenberg, \textit{Schemata over local rigns II}, Ann. Math. {\bf 78} (1963)
256-266.
\bibitem [Gr]{art6-keyGr} A. Grothendieck \textit{Sur quelques points d'alg\`ebrr homologiguw}, Tohoku  Math. Jour. {\bf 9} (1957) 119-221.

\bibitem [H]{art6-keyH} W. J.Haboush, \textit{Reductive groups are geometrically reductive}, Ann. Math. {\bf 102}(1975) 67-83. 
\bibitem [Hu]{art6-keyHu} J. E. Humphreys. \textit{Introduction to Lie Algebras and Representation Theory}, Springer-Verlag, New York(1991)
\bibitem [NM]{art6-keyNM} N. Iwaori and H. Matsumoto, \textit{On some Bruhat decomposiotion and teh structre of the Hecke rings of $p$-adic Chevalley groups}, Publ. Math. IHES {\bf 25} (1965) 5-48.

\bibitem [KL]{art6-keyKL} D. Kazxhadan and G. Lausztig, \textit{Proof of the Deligne-Langlands conjecture for Hecke algebras}, Inv. Math. {\bf 87} (1987) 153-215.
\bibitem [L1]{art6-keyL1} G. Lusztig, \textit{Hecke algebras and Jangtzene's generic decompsition paterns}, Adv. in Math. {\bf 37} (1980) 121-164.
\bibitem [L2]{art6-keyL2} G. Lusztig,\textit{Some examplex of squar integrable representations of $p$-adic groups}, Trans. Amer. Math. Soc. {\bf 277}(1983) 623-653.
\bibitem [L3]{art6-keyL3} G. Lusztig, \textit{Equivariant K-theory and representations of Hecke algebras}, Proc. Amer. Math. Soc. {\bf 94} (1985) 337-342.
\bibitem [L4]{art6-keyL3} G. Lusztig, \textit{Equivariant K-theory and representations of Hecke algebras II,} INv. Math
{\bf 80} (1985) 209-231

\bibitem [M]{art6-keyM} I. G. Macdonald, \textit{Spherical fucntions on a groups of $p$-adic type}, Ramanujan Institute Lecture Notes, Ramanujan Institute, Centre for Advanaced Study in Mathematics, Madras (1971) 1-79.

\bibitem [Mac]{art6-keyMac} S. MacLane. \textit{Homology}, Die Grundlehren der Mathematischen Wiesensaften in Einzeldarstellungen Vol. {\bf 114}, Academic Press, Springer-Verlag, Berlin-G\"ottingenr-Heidelberg (1963) 1-422.

\bibitem [PS]{art6-keyPS} A. pressely and G. Segal, \textit{Loop Groups}, Clarendon Press, Oxford (1986).

\bibitem [R]{art6-keyR} M. Ronan, \textit{Lectures on buildings}, Perspectives in Mathematics, {\bf 7} Academic Press, Harcourt Brace Jovanovich, Boston-San Diego-New York-Derkeley-London-Sydney-Tokyo-Toronto (1989) 1-201.
\bibitem [RS]{art6-keyRS} M. Ronan and S. d. Smith, \textit{Sheaves on buildings and modular representations of Chevalley groups}, J. Algebra {\bf 96} (1985)
\bibitem [S]{art6-keyS} L. Solomon, \textit{Mackey formula in the group ring of a Coxeter group}, J. Aglebra {\bf 41} (1976) 225-264.
\bibitem [T]{art6-keyT} J. Tits, \textit{Two properties of Coxeter complexes}, appendix to \textit{A Makey formula in the group in the group ring of a Coxerter group} J. Algebra {\bf 41} (1976) 255-264.
\end{thebibliography}
