\chapter{Scalar conservation laws with boundary condition}\label{chap8}

\lhead[\thepage]{\textit{Scalar conservation laws with boundary condition}}
\rhead[\textit{K. T. Joseph}]{\thepage}
...
Existence\pageoriginale and uniqueness of weak solution of \eqref{chap8-eq-1.1} and \eqref{chap8-eq-1.2} satsifying the entropy condition \eqref{chap8-eq-1.3} is well known (see Hopf \cite{chap8-key2}, Lax \cite{chap8-key9}, Olenik \cite{chap8-key14}, Kruskov \cite{chap8-key7} and Quinn \cite{chap8-key13}). Hopf \cite{chap8-key2} derived an explicit for the solution when $f(u) = \frac{u^{2}}{2}$ and Lax \cite{chap8-key9} extended this formula for general convex $f(u)$.
...
Let us consider the mixed initial boundary value problem for \eqref{chap8-eq-1.1} in $x >0$, $t > 0$. We prescribe the initial data.
...
Bardos et al \cite{chap8-key1} proved the existence and uniqueness of solution of \eqref{chap8-eq-1.1}, \eqref{chap8-eq-1.10} and \eqref{chap8-eq-1.11} (see also Lefloch \cite{chap8-key10}). We are interested in extending Lax formula \eqref{chap8-eq-1.8} for the solution, which contains solution of a variational inequality. This cariational inequality is not solvable explicit. In a series of papers Joseph \cite{chap8-key3}, Joseph and Veerappa Gowda
...
\section{Lax's equation}\label{chap8-sec-3}
\pageoriginale
...
\begin{equation}\label{chap8-eq-3.7}
V_{k}^{n}=\left\{
\begin{aligned}
...
Following Lax \cite{chap8-key9}, we introduce
\setcounter{equation}{0}
...
\bibitem{chap8-key1} Bardos, C. Leroux, A.Y. and Nedelec, J.C., \textit{First order quasilinear equations with boundary conditions}, Comm. Partial Differential equations {\bf 4} (1979) 1017--1034.

\bibitem{chap8-key2} Hopf, E. \textit{The partial differential equation}$ u_{t}uu_{x}=\mu U_{xx}$, Comm. Pure and Appl. Math {\bf 13} (1950) 201--230.
\bibitem{chap8-key3} Joseph, K.T. \textit{Burgers equation in the quarter plane, a formula for the weak limit}, Comm. Pure and Appl. Math {\bf 41} (1988) 133--149.
\bibitem{chap8-key4} Joseph, K. T. and Veerappa Gowda, G. D., \textit{Explicit-formula for the limit of a difference approximation}, Duke Math. J. {\bf 61} (1990) 369--393.

\bibitem{chap8-key5} Joseph, K. T. and Veerappa Gowda, G. D., \textit{Explicit-formula for the solution of convex conservation laws wit boundary condition}, Duke Math. J. {\bf 62} (1991) 401--416.

\bibitem{chap8-key6} Joseph, K. T. and Veerappa Gowda, G.D., \textit{Solution of convex conservation laws is a strip}, Proc Ind. Acad. Sci, {\bf 102}, 1,(1992) 29--47.

\bibitem{chap8-key7} Kruskov, S. \textit{First order quasilinear equations with several space variables}, Math. USSR Sb,
 {\bf 10} (1970) 217--273.
\bibitem{chap8-key8} Lax, P.D.,\pageoriginale \textit{Weak solutions of non linear hyperbolic equations and their numerical computation}, Comm. Pure Appl. Math {\bf 7} (1954) 159--193.

\bibitem{chap8-key9} Lax, P. D: \textit{Hyperbolic Systems of Conservation laws II}, Comm. Pure Appl. Math. {\bf 10} (1957) 537--566.
 
\bibitem{chap8-key10} Lefloch, P.,\textit{Explicit-formula for Scalar non-linear Conservation laws with boundary condition}, Math Methods in Appl. Sci {\bf 10} (1988) 265--287.

\bibitem{chap8-key11} Lions, P.L., \textit{Generalized solutions of Hamilton-Jacobi equation}, Pitman Lecture Notes, Pitman, London (1982).

\bibitem{chap8-key12} Lions, P.L., \textit{Neumann type boundary conditions for Hamilton-Jacobi equations}, Duke Math. J.
{\bf 52} (1985) 793--820.

\bibitem{chap8-key13} Quinn, B., \textit{Solutions with shocks: an example of $L^{1}$- contraction semi-group}, Comm. Pure Appl. Math. {\bf 24} (1971) 125--132.

\bibitem{chap8-key14} Oleinik, O.,\textit{Discontinuous solutions of non-linear differential equation}, Usp. Mat. Nauk, (N.S), {\bf 12} (1957) 3--73; English transl. in AMS Transl. Ser. 2, {\bf 26} (1957) 95--172.
\end{thebibliography}
