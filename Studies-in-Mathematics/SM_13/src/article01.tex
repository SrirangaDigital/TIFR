...
\bibitem{chap1-key15} S.S. Abhyankar, H. Popp and W. K. Seiler, \textit{Mathieu group coverings of the affine line,} Duke Math. Jour. {\bf 68} (1992) 301-311.
...
\bibitem{chap1-key32} D. Gorenstein, \textit{Classifying the finite simple groups,} Bull. Amer. Math. Soc. {\bf 14} (1986) 1-98.
...
\bibitem{chap1-key47} I. Newton, \textit{Geometria Analytica} 1680.
...
\bibitem{chap1-key62} H. Zassenhaus, \textit{Kennzeichung endlicher linearen Gruppen als Premutationgruppen,} Abh. Mth. Sem. Univ. Hamburg {\rm (11)} (1936) 17-744.
\end{thebibliography}
