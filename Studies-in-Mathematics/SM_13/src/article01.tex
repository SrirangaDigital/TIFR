\chapter{Fundamental Group of the Affine Line in Positive Characteristic}\label{chap1}

\lhead[\thepage]{\textit{Fundamental Group of the Affine Line in Positive Characteristic}}
\rhead[\textit{Shreeram S. Abhyankar}]{\thepage}
...
\section{Galois}\label{chap1-sec3}
...
\section{Serre}\label{chap1-sec6}
...
Strangely, the answers to both these questions turned out to be almost the same. Namely, with much prodding and prompting by Serre (hundred e-mails and a dozen s-mails=snail-mails) augmented by groups theory lessons first from Kantor and Feit and then Cameron and O'Nan, and by using the method of throwing away roots, CT in the guise of CDT, the Cycle Lemmas, the Jordan-Marggraff Theorems on limits of transitivity (see Jordan \cite{chap1-key39} and Marggraff \cite{chap1-key45} or Wielandt \cite{chap1-key60}), and finally some High-School type factorizations, in the papers \cite{chap1-key8} to \cite{chap1-key10} I proved that: 
\begin{align}
...
Throwing away one root of $\overline{F}_{n,q,s,a}$ and then applying Abhyankar's Lemma (see pages 181-186) of Part III of \cite{chap1-key4}) and deforming things conveniently, we get the monic polynomial $\overline{F}_{n,q,s,a,b,u}$ of degree $n-1$ in $Y$ with coefficient in $k(x)$\pageoriginale given by
$$
...
\section{Ramanujan}\label{chap1-sec9}
...
But postponing this to another lecture on another day, let me end with a few equational questions suggested by the experimental data presented in this\pageoriginale lecture.
...
\pageoriginale
\bibitem{chap1-key1} S.S. Abhyankar, \textit{On the ramification of algebraic functions}, Amer. Jour. Math. {\bf 77} (1955) 572--592.
\bibitem{chap1-key2} S.S. Abhyankar, \textit{Local uniformization on algebraic surfaces over ground fields of characteristics} $p\neq 0$, Ann. Math. {\bf 63} (1956) 491--526.
\bibitem{chap1-key3} S.S. Abhyankar, \textit{Coverings of algebraic curves,} Amer. Jour. Math. {\bf 79} (1957) 825--856.
\bibitem{chap1-key4} S.S. Abhyankar, \textit{Tame coverings and fundamental groups of algebraic varieties, Parts I to VI,} Amer.Jour.Math. {\bf 81, 82} (1959--60).
\bibitem{chap1-key5} S.S. Abhyankar, \textit{Historical ramblings in algebraic geometry and related algebra,} Amer. Math. Monthly {\bf 83} (1976) 409--448.
\bibitem{chap1-key6} S.S. Abhyankar, \textit{Algebraic Geometry for Scientists and Engineers,} Mathematical Surveys and Monographs {\bf 35}, Amer. Math. Soc., Providence, 1990.
\bibitem{chap1-key7} S.S. Abhyankar, \textit{Group enlargements,} C. R. Acad. Sci. Paris {\bf 312} (1991) {\bf 763--768}.
\bibitem{chap1-key8} S.S. Abhyankar, \textit{Galois theory on the line in nonzero characteristic,} Bull. Amer. Math. Soc. {\bf 27} (1992) 68--133.
\bibitem{chap1-key9} S.S. Abhyankar, \textit{Square-root parametrization of plane curves,} Algebraic Geometry and Its Applications, Springer-Verlag (1994) 19--84.
\bibitem{chap1-key10} S.S. Abhyankar, \textit{Alternating group coverings of the affine line in characteristic greater than two,} Math. Annalen {\bf 296} (1993) 63--68.
\bibitem{chap1-key11} S.S. Abhyankar, \textit{Wreath products and enlargements of groups,} Discrete Math. {\bf 120} (1993) 1--12.
\bibitem{chap1-key12} S.S. Abhyankar, \textit{Linear disjointness of polynomials,} Proc. Amer. Math. Soc. {\bf 116} (1992) 7--12.
\bibitem{chap1-key13} S.S. Abhyankar, \textit{Invariant theory and enumerative combinatories of Young tableaux,} Geometric Invariance in computer Vision, Edited by J. L. Mundy and A. Zisserman, MIT Press (1992) 45--76.
\bibitem{chap1-key14} S.S. Abhyankar, J. Ou and A. Sathaye, \textit{Alternating group coverings of the affine line in characteristic two,} Discrete Mathematics, (To Appear).
\bibitem{chap1-key15} S.S. Abhyankar,\pageoriginale H. Popp and W. K. Seiler, \textit{Mathieu group coverings of the affine line,} Duke Math. Jour. {\bf 68} (1992) 301--311.
\bibitem{chap1-key16} S.S. Abhyankar, H. Popp and W. K. Seiler, \textit{Construction techniques for Galois coverings of the affine line,} Proceedings of the Indian Academy of Sciences {\bf 103} (1993) 103--126.
\bibitem{chap1-key17} S.S. Abhyankar and I. Yie, \textit{Small degree coverings of the affine line in characteristic two,} Discrete Mathematics (To Appear).
\bibitem{chap1-key18} C. Arf, \textit{Untersuchungen iiber quadratische Formen in K\"orpern der Characteristik 2(Teil I.),} Crelle Journal {\bf 183} (1941) 148--167. 
\bibitem{chap1-key19} E. Berlekamp, \textit{Algebraic Codign Theory} McGraw-Hill, 1968.
\bibitem{chap1-key20} E. Berlekamp, \textit{An analog to the discriminant over fields of characteristic 2,} Journal of Algebra {\bf 38} (1976) 315--317.
\bibitem{chap1-key21} R. C. Bose, \textit{On the construction of balanced incomplete block designs,} Ann, Eugenics {\bf 9} (1939) 353--399.
\bibitem{chap1-key22} P.J. Cameron, \textit{Finite permutation groups and finite simple groups,} Bull. Lond. Math. Soc. {\bf 13} (1981) 1--22.
\bibitem{chap1-key23} P.J. Cameron. \textit{Permutation groups,} Handbook of Combinatorics, Elsevier, Forthcoming.
\bibitem{chap1-key24} P.J. Cameron and J. Cannon, \textit{Fast recongnition of doubly transitive groups,} Journal of Symbolic Computations {\bf 12} (1991) 459--474.
\bibitem{chap1-key25} L. Carlitz, \textit{Resolvents of certain linear groups in a finite field,} Canadian Jour. Math.{\bf 8} (1956) 568--579.
\bibitem{chap1-key26} C. Chevalley, \textit{Theory of lie Groups,} Princeton University Press, 1946.  
\bibitem{chap1-key27} G. Chrystal, \textit{Textbook of Algebra,} Parts I and II, Edinburgh, 1886.
\bibitem{chap1-key28} R, Dedekind and H. Weber, \textit{Theorie der Algebraischen Funktionen einer Ver\"anderlichen,} Crelle Joournal {\bf 92} (1882) 181--290.
\bibitem{chap1-key29} P. Dembowski, \textit{Finte Geometries}, Spirnger-Verlag, 1968.
\bibitem{chap1-key30} W, Feit \textit{On a class of doubly transitive permutation groups,} Illinois Jour. Math. {\bf 4} (1960) 170--186.
\bibitem{chap1-key31} A. R. Forsyth, \textit{Theory of Functions of a Complex Variable,} Cambridge University Press, 1918.
\bibitem{chap1-key32} D. Gorenstein,\pageoriginale \textit{Classifying the finite simple groups,} Bull. Amer. Math. Soc. {\bf 14} (1986) 1--98.
\bibitem{chap1-key33} A. Grothendieck, \textit{Rev\^etements \'Etales et Groupe Fondamental (SGA 1),} Lecture Notes in Mathematics {\bf 224} Springer-Verlag, 1971.
\bibitem{chap1-key34} D.G. Higman, \textit{Finite permutation groups of rank 3,} Math. Z. {\bf 86} 145--156.
\bibitem{chap1-key35} D. Hilbert, \textit{\"Uber das Dirichletesche Prinzip,} Mathematische Annalen {\bf 59} (1904) 161--186.
\bibitem{chap1-key36} B. Huppert and N. Blackburn, \textit{Finite Groups I, II, III,} Springer-Verlag, New York, 1982.
\bibitem{chap1-key37} N. Jacobson, \textit{Lectures in Abstract Algebra, Vol III,} Van Nostrand, Princeton, 1964.
\bibitem{chap1-key38} N. Jacobson, \textit{Basic Algebra, Vol I,} W. H. Freeman and Co. San Francisco, 1974.
\bibitem{chap1-key39} C. Jordan, \textit{Sur la limite de transitivit\'e des groupes non altern\'es,} Bull. Soc. Math. France {\bf 1} (1973) 40--71.
\bibitem{chap1-key40} H. W. E. Jung,\textit{Darstellung der Funktionen eines algebraischen K\"orperszweier unabh\"angigen Ver\"angigen Ver\"anderlichen in der Umgebung einer Stelle,} Crelle Journal {\bf 133} (1908) 289--314.
\bibitem{chap1-key41} W. M. Kantor, \textit{Homogeneous designs and geometric lattices,} Journal of Combinatorial Theory, Series A {\bf 38} (1985) 66--74.
\bibitem{chap1-key42} W. M. Kantor and R. L. Liebler, \textit{The rank  3 permutation representations of the finite classical groups,} Trans. Amer. Math. Soc. {\bf 271} (1982) 1--71.
\bibitem{chap1-key43} F. Klein and R. Fricke, \textit{Vorlesungen \"uber die Theorie der Elliptischen Modulfunctionen,} 2 volumes, Teubner, Leipzig, 1890.
\bibitem{chap1-key44} M. W. Liebeck, \textit{The affine permutation groups of rank three,} Proc. Lond. Math. Soc. {\bf 54} (1987) 447--516.
\bibitem{chap1-key45} B. Marggraff, \textit{\"Uber primitive Gruppern mit transitiven Untergruppen geringeren Grades,} Dissertation, Giessen, 1892.
\bibitem{chap1-key46} E. Mathieu, \textit{M\'emoire sur l'\'etude des fonctions de plusieurs quantit\'es, sur la mani\`ere de les former, et sur les substitutions qui les laissent invariables,} J. Math Pures Appl. {\bf 18} (1861) 241--323.
\bibitem{chap1-key47} I. Newton,\pageoriginale \textit{Geometria Analytica} 1680.
\bibitem{chap1-key48} M. Noether, \textit{\"Uber einen Satz aus der Theorie der algebraischen Funktionen,} Math. Annalen {\bf 6} (1873) 351--359.
\bibitem{chap1-key49} M .V. Nori, \textit{Unramified coverings of the affine line in positive characteristic} Algebraic Geometry and Its Applications, Springer-Verlag (1994) 209--212.
\bibitem{chap1-key50} S. Ramanujan, \textit{Collected Papers,} Cambridge University Press, 1927.
\bibitem{chap1-key51} S. Ramanujan, \textit{Ramanujan Revisited,} Proceedings of the Centenary Conference at University of Illinois, Edited by G. E. Andrews, R. A. Askey, B. C. Berndt, K. G. Ramanathan and R. A. Rankin, Academic Press, 1987.
\bibitem{chap1-key52} B. Riemann, \textit{Grundlagen f\"ur eine allgemeine Theorie der Functionen einer ver\"anderlichen complexen Gr\"osse,} Inauguraldissertation, G\"ottingen (1851). Collected Works, Dover (1953) 3--43.
\bibitem{chap1-key53} B. Riemann, \textit{Theorie der Abelschen Funktionen,} Jour. f\"ur die reine undang. Mathematik {\bf 64} (1865) 115--155.
\bibitem{chap1-key54} H. Seifert and W. Threlfall, \textit{Lehrbuch der Topologie,} Teubner, 1934.
\bibitem{chap1-key55} J-P. Serre, \textit{G\'eom\'etrie alg\'ebrique et g\'eom\'etrie analytique,} Ann. Inst. Fourier {\bf 6} (1956) 1--42.
\bibitem{chap1-key56} J-P. Serre, \textit{Construction de rev\^etments \'etales de la droite affine en charact\'eristic p,} C. R. Acad. Sci. Paris {\bf 311} (1990) 341--346.
\bibitem{chap1-key57}J-P. Serre, \textit{A letter as an appendix to the squar-root parametrization paper of Abhyankar,} Algebraic Geometry and Its Applications, Springer-Verlag (1994) 85--88.
\bibitem{chap1-key58} S. S. Shrikhande, \textit{The impossibility of certain symmetrical balanced incomplete block designs,} Ann. Math. Statist. {\bf 21} (1950) 106--111.
\bibitem{chap1-key59} M. Suzuki. \textit{On a class of doubly transitive groups, Ann. Math. {\bf 75} (1962) 104--145}.
\bibitem{chap1-key60} H. Wielandt. \textit{Finite Permutation Groups,} Academic Press, New York, 1964.
\bibitem{chap1-key61} E. Witt. \textit{Theorie der quadratischen Formen in beliebigen K\"orpern,} Crelle Journal {\bf 176} (1937) 31--41.
\bibitem{chap1-key62} H. Zassenhaus,\pageoriginale \textit{Kennzeichung endlicher linearen Gruppen als Premutationgruppen,} Abh. Mth. Sem. Univ. Hamburg {\rm (11)} (1936) 17--744.
\end{thebibliography}
