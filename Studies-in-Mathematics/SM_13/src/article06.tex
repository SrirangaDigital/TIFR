\chapter{Algebraic Representations of Reductive Groups over Local Fields}\label{chap6}

\lhead[\thepage]{\textit{Algebraic Representations of Reductive Groups over Local Fields}}
\rhead[\textit{William J. Haboush}]{\thepage}
...
\section{Carapaces and their Homology}\label{chap6-sec-1}
\pageoriginale
...
\begin{definition}\label{chap6-definition-1.9}
...
\section{Operations on Carapaces}\label{chap6-sec-2}
\pageoriginale
...
The local homorophism functor, $\calH om_{R, X}(A, B)$, is additive, covariant in $B$ and contravariant in $A$ and left exact in both variables. Moreover
    \begin{enumerate}[(1)]
    \item $\calH om_{R, X}(R_{X}, A)\simeq A$, \text{\rm functorially in} $A$\label{chap6-thm2.4-enum-(1)}
...
\begin{seclem}\label{chap6-lemma-3.1}
...
\begin{definition}\label{chap6-definition-3.2}
...
\begin{secprop}\label{chap6-proposition-4.2}
...
\begin{secprop}\label{chap6-prop-5.4}
...
\section{Certain Special Carapaces}\label{chap6-sec-6}
...
\begin{secprop}\label{chap6-proposition-6.7}
...
\begin{secprop}\label{chap6-proposition-6.11}
...
\begin{definition}\label{chap6-definition-7.4}
...
To see that these are representation, we just apply \ref{chap6-eq-8.3} Then, $(\Phi^{\Sigma})_{{g}h} = I_{A}^{{g} h} \circ (\Phi_{{g} h})^{\Sigma} = I_{A}^{{g}} \circ I_{h}^{{g}^{*} A}
...
We check that $\Theta$ is a $G$-structure by establishing \ref{chap6-eq-8.5} for it by direct computation. The computation is:
\begin{align*}
...
\begin{seclem}\label{chap6-lemma-8.10}
...
Only \ref{chap6-proposition9.3-enum-2}) remains to be proved. We compute directly.
\begin{align*}
...
\begin{secprop}\label{chap6-proposition-9.8}
...
Before proceeding note that if $Y \subseteq X$, if $\sigma \in Y$ and if $M$ is an $R$-module, we may perform the constructions $M \uparrow_{\sigma}$ and $M \downarrow^{\sigma}$ both in $X$ and in $Y$ and\pageoriginale that the results might differ. Rather than lingering upon unnecessary distinctions or unnecessarily complicating notation, we caution the reader to maintain a certain vigilance in reading the next proof.
...
\begin{seclem}\label{chap6-lemma-10.2}
...
\begin{secprop}\label{chap6-proposition-13.2}
...
\begin{seclem}\label{chap6-lemma-14.7}
...
\bibitem[B1]{chap6-keyB1} A. Borel, \textit{Admissible representations of a semi-simple group over a local field with vectors fixed under an Iwahori subgroup}, Invent. Math. {\bf 35} (1976) 233--259.
\bibitem [B2]{chap6-keyB2} A. Borel, \textit{Linear Algebraic Groups}, second enlarger edition, Springer-Verlag, New York (1991).
\bibitem [BW]{chap6-keyBW} A. Borel and N. Wallach, \textit{Continuous Cohomology, Discrete Subgroups and Representations of Reductive Groups}, Annals of Mathematics Studies, {\bf 94} Princeton University Press. Princeton, New Jersey (1980) 3--381.
\bibitem[Bo]{chap6-keyBo} N, Bourbaki,\pageoriginale \'El\'ements de math\'ematique, Fasc. XXXIV, Groupes et Alg\`ebres de Lie, IV, V and VI, Actualit\'es Scientifiques et Industrielles, {\bf 1337} Hermann, Paris (1968).

\bibitem[Br]{chap6-keyBr} K.S. Brown, \textit{Buildings}, Springer-Verlag, New York (1989) 1--209.

\bibitem[BTI]{chap6-keyBT-I} F. Bruhat and J. Tits, \textit{\'Groupes R\'eductifs sur un Corps Local I. Donn\'ees radicielles valu\'ees} Publ. Math IHES, {\bf 41} (1972) 5--252.

\bibitem[BT II]{chap6-keyBT-II}F. Bruhat and J. Tits, \textit{Groupes R\'eductifs sur un Corps Local II. Sch\'emas en groupes. Existence d'une don\'ee radicielle valu\'ee}, Publ. Math. IHES, {\bf 60} (1984) 5--184.

\bibitem[CE]{chap6-keyCE} H. Cartan and S. Eilenberg, \textit{Homological Algebra}, Princeton University Press, Princeton, New Jersey (1956).

\bibitem[C]{chap6-keyC} P. Cartier, \textit{Representations of $p$-adic groups}, A survey in \textit{Automprphice forms, representatons and $L$-functions $I$}, Proceeding on the Symposium in pure Mathematics, {\bf 33} American Mathematical Society, Providence, Rhode Island (1979) 111--155.

\bibitem [CW]{chap6-keyCW} W. Casselman and D. Wigner, \textit{Continuous cohomology and a conjecture of Serre's}, Invent. Math {\bf 25} (1974) 199--211.

\bibitem [Go]{chap6-keyGo} R.Godement, \textit{Th\'eorie des faisecaux}, Act. Sci. Ind. {\bf 1252} Hermann, Paris (1958)

\bibitem [MGI]{chap6-keyMG-I} M. J. Greenberg, \textit{Schemata over local rings}, Ann. Math {\bf 73} (1961) 624--648.

\bibitem [MG II]{chap6-keyMG II} M . J. Greenberg, \textit{Schemata over local rigns II}, Ann. Math. {\bf 78} (1963)
256--266.
\bibitem [Gr]{chap6-keyGr} A. Grothendieck \textit{Sur quelques points d'alg\`ebrr homologiguw}, Tohoku  Math. Jour. {\bf 9} (1957) 119--221.

\bibitem [H]{chap6-keyH} W. J.Haboush, \textit{Reductive groups are geometrically reductive}, Ann. Math. {\bf 102}(1975) 67--83. 
\bibitem [Hu]{chap6-keyHu} J. E. Humphreys. \textit{Introduction to Lie Algebras and Representation Theory}, Springer-Verlag, New York(1991)
\bibitem [NM]{chap6-keyNM} N. Iwaori and H. Matsumoto, \textit{On some Bruhat decomposiotion and teh structre of the Hecke rings of $p$-adic Chevalley groups}, Publ. Math. IHES {\bf 25} (1965) 5--48.

\bibitem [KL]{chap6-keyKL} D. Kazxhadan\pageoriginale and G. Lausztig, \textit{Proof of the Deligne-Langlands conjecture for Hecke algebras}, Inv. Math. {\bf 87} (1987) 153--215.
\bibitem [L1]{chap6-keyL1} G. Lusztig, \textit{Hecke algebras and Jangtzene's generic decompsition paterns}, Adv. in Math. {\bf 37} (1980) 121--164.
\bibitem [L2]{chap6-keyL2} G. Lusztig,\textit{Some examplex of squar integrable representations of $p$-adic groups}, Trans. Amer. Math. Soc. {\bf 277}(1983) 623--653.
\bibitem [L3]{chap6-keyL3} G. Lusztig, \textit{Equivariant K-theory and representations of Hecke algebras}, Proc. Amer. Math. Soc. {\bf 94} (1985) 337--342.
\bibitem [L4]{chap6-keyL4} G. Lusztig, \textit{Equivariant K-theory and representations of Hecke algebras II,} INv. Math
{\bf 80} (1985) 209--231

\bibitem [M]{chap6-keyM} I. G. Macdonald, \textit{Spherical fucntions on a groups of $p$-adic type}, Ramanujan Institute Lecture Notes, Ramanujan Institute, Centre for Advanaced Study in Mathematics, Madras (1971) 1--79.

\bibitem [Mac]{chap6-keyMac} S. MacLane. \textit{Homology}, Die Grundlehren der Mathematischen Wiesensaften in Einzeldarstellungen Vol. {\bf 114}, Academic Press, Springer-Verlag, Berlin-G\"ottingenr-Heidelberg (1963) 1--422.

\bibitem [PS]{chap6-keyPS} A. pressely and G. Segal, \textit{Loop Groups}, Clarendon Press, Oxford (1986).

\bibitem [R]{chap6-keyR} M. Ronan, \textit{Lectures on buildings}, Perspectives in Mathematics, {\bf 7} Academic Press, Harcourt Brace Jovanovich, Boston-San Diego-New York-Derkeley-London-Sydney-Tokyo-Toronto (1989) 1--201.
\bibitem [RS]{chap6-keyRS} M. Ronan and S. d. Smith, \textit{Sheaves on buildings and modular representations of Chevalley groups}, J. Algebra {\bf 96} (1985)
\bibitem [S]{chap6-keyS} L. Solomon, \textit{Mackey formula in the group ring of a Coxeter group}, J. Aglebra {\bf 41} (1976) 225--264.
\bibitem [T]{chap6-keyT} J. Tits, \textit{Two properties of Coxeter complexes}, appendix to \textit{A Makey formula in the group in the group ring of a Coxerter group} J. Algebra {\bf 41} (1976) 255--264.
\end{thebibliography}
