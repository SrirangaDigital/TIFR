...
\medskip
\noindent
{\bfseries \thnum{2.3} Lemma. \label{art12-Lemma-2.3}}~\textit{If\pageoriginale $T$ is a locally noetherian $S$-scheme and of $E$ is a$T$-flat coherent sheaf on $X \times_{s}T$ such that for every geometric point t of $T$, $E(t)$ is torsion free, then $E|_{D}=E\otimes_{\calO_{X}}\calO_{D}$ is flat over $T$}.
...
\bibitem{art12-key7} M. Maruyama\pageoriginale and K. Yokogawa, \textit{Moduli of parabolic stable sheaves}, to appear in Math. Ann.
