\chapter{Poncelet Polygons and the Painlev\'e Equations}
...
\begin{thm}[{\bf Malgrange \cite{art7-key10}}]\label{art7-thm-1}
...
\begin{proposition}\label{art7-proposition-1}
...
\begin{proposition}\label{art7-proposition-2}
...
\begin{proposition}\label{art7-proposition-3}
...
\begin{proposition}\label{art7-proposition-4}
...
\subsection{Solutions for \boldmath$k=4$}\label{art7-subsec-6.2}
~
...
\subsection{Solution for \boldmath$k=5$}\label{art7-subsec-6.3}
~
...
The study of the Poncelet constraints for smal values of $k$ in undertaken in \cite{art7-key1}, and the reader will find that, apart from $k=6$ and $k=8$, the formulae
...
\section{Painlev\'e curves}\label{art7-sec-7}
\pageoriginale
...
Coincidentally, the investigation of the Poncelet problem by Barth and Michel in \cite{art7-key1} proceeds by studying a modular curve. This is curve which occurs in parametrizing elliptic curves with     
\begin{itemize}
...
\bibitem{art7-key1} W. Barth \& \ J. Michel. \textit{Modular curves and Poncelet polygons,} Math. Ann. {\bf 295} (1993) 25--49.

\bibitem{art7-key2} G. V. Belyi, \textit{On Galois extensions of a maximal cyclotomic, field}, Math. USSR Izvestiya,
{\bf 14} (1980) 247--256.

\bibitem{art7-key3} H. J. M. Bos, C. Kers, F. Oort \& \ D. W. Raven, \textit{Poncelet,s closure theorem,} Exposition. Math. {\bf 5} (1987) 289--364.

\bibitem{art7-key4} R. Fuchs, \textit{\"Uber linear homogene Differentialgleichungen zweiter Ordnung mit drei im Endlichen gelegene wesentilich singul\"aren Stellen,}Math. Ann. {\bf 63} (1907) 301--321.

\bibitem{art7-key5} Ph. Griffiths \& J. Harris, \textit{On Cayley,s explicit solution to Poncelet,s porishm}, Enseign. Math {\bf 24} (1978) 31--40.

\bibitem{art7-key6} N. J. Hitchin, \textit{A new family of Einstien metrics}, Proceeding of conference in honour of E. Calabi, Pisa (1993), Academic Press (to appear)

\bibitem{art7-key7} N. J. Hitchin, \textit{Twistor spaces and isomonodromic deformations}, (in preparation)

\bibitem{art7-key8} M. Jimbo and T. Miwa, \textit{Monodromy preserving deformation of linear ordinary differential equations with rational coefficients II}, Physica, {\bf 2D} (1981) 407--448.

\bibitem{art7-key9} K. Kodaira, \textit{A theorem of completeness of characteristic systems for analytic families of compact submanifolds of complex manifolds}, Ann. of Math, {\bf 75} (1962) 146--162.
 
\bibitem{art7-key10} B. Malgrange, \textit{Sur les deformations isimonodromiques I. Signgularit\'es r\'eguli\`eres}, in MNath\'ematique et Physique, S\'emainaire de l'Ec\.{o}le Normale Sup\'erieure 1979-1982, Progress in Mathematics
{\bf 37}, Birkh\"a user, Boston (1983) 401--426.

\bibitem{art7-key11} V. B Mehta and C.S. Seshadri, \textit{Moduli of vector bundles on curves with parabolic structure}, Math. Ann. {\bf 28} (1980) 205--239.
\bibitem{art7-key12} S. Mukai\pageoriginale and H. Umemura, \textit{Minimal rational 3-folds}, in Algebraic Geometry (Proceedings, TOkoyo/Kyoto 1982), Lecture Notes in Mathematics No.1016, Springer, Heidelberg (1983) 490--518.

\bibitem{art7-key13} M. S. Narasimhan and C. S Seshadri, \textit{Stable and unitary bundles on a compact Riemann surface}, Ann. of Math. {\bf 82} (1965) 540--567.

\bibitem{art7-key14} M. S. Narasimhan and G. Trautmann, \textit{Compactification of $M_{P_{3}}$(0,2) and Poncelet pairs of conics}, Pacific J. Math. {\bf 145} (1990) 255--365.
 
\bibitem{art7-key15} L. Schlesinger, \textit{\"Uber eine Klasse von differentialsystemen beliebiger Ordnung mit festen Kritishcher Punkten}, J. f\"ur Math. {\bf 141} (1912) 96--145.

\bibitem{art7-key16} R. L. E. Schwarzenberger, \textit{Vector bundles on the projective plane}, Proc. London Math. Soc. {\bf 11} (1961) 623--640.

\bibitem{art7-key17}A. Weil, \textit{The field of definition of a variety}, American J. Math. {\bf 78} (1956) 509--524.
\end{thebibliography}
