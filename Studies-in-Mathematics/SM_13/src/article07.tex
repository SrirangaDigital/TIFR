...
\subsection{Solutions for $k=4$}\label{art7-subsec-6.2}
...
\subsection{Solution for $k=5$}\label{art7-subsec-6.3}
~
...
\bibitem{art7-key12} S. Mukai and H. Umemura, \textit{Minimal rational 3-folds}, in Algebraic Geometry (Proceedings, TOkoyo/Kyoto 1982), Lecture Notes in Mathematics No.1016, Springer, Heidelberg (1983) 490-518.
