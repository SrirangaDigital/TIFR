...
\newtheoremstyle{romanthm}{10pt}{10pt}{\it }%
{}{\bfseries}{.}{ }{#1 I.#2}
\theoremstyle{romanthm}
\newtheorem{romanlemma}{Lemma}
\newtheorem{romantheorem}[romanlemma]{Theorem}
\newtheorem{romancorollary}[romanlemma]{Corollary}



%%% Lemma A
\theoremstyle{alphlemma}
...
%%% Proof of Lemma A
%\theoremstyle{alphproofoflem}
%\newtheorem{alphproofoflem}{proofoflem}
%\renewcommand{\thealphproofoflem}{\Alph{alphproofoflem}}
%\renewcommand{\thesection}{\arabic{section}}

\newtheoremstyle{romantheorem}{10pt}{10pt}{\it }%
{}{\bfseries}{.}{ }{#1 A.#2}
\theoremstyle{romantheorem}
\newtheorem{appenprop}{Proposition}
\newtheorem{appencoro}[appenprop]{Corollary}
...
\newtheorem{subremark}[definition]{Remark}
...
\newtheorem{numproof}[definition]{Proof}
...
\newtheorem{note*}{Note}
\newtheorem{cremarks*}{Concluding Remarks}
