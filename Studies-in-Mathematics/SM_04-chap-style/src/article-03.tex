\chapter[\textsc{B. J. Birch} : Diophantine Analysis and Modular Functions]{DIOPHANTINE ANALYSIS AND MODULAR FUNCTIONS}\label{art03}

\begin{center}
{\em By}~~ B. J. Birch
\end{center}

\lhead[\thepage]{\textit{Diophantine Analysis and Modular Functions}}
\rhead[\textit{B. J. Birch}]{\thepage}
...
\medskip
\noindent
{\bf Theorem \thnum{1}.\label{art03-thm1}}
...
\medskip
\noindent
{\bf Theorem \thnum{2}.\label{art03-thm2}}
...
\medskip
\noindent
{\bf Theorem \thnum{3}\label{art03-thm3}}~(S\"ohngen \cite{art03-key6}).
...
\medskip
\noindent
{\bf Example \thnum{1}\label{art03-exam1}}~(Wiber \cite{art03-key9} \S125).
...
\medskip
\noindent
{\bf Example \thnum{2}.\label{art03-exam2}}
...
\medskip
\noindent
{\bf Example \thnum{3}\label{art03-exam3}}~(\cite{art03-key9} \S134).
