\chapter[\textsc{B. Dwork~:} A Deformation Theory for Singular Hyper-surfaces]{A DEFORMATION THEORY FOR SINGULAR HYPERSURFACES}\label{art07}

\begin{center}
By~~ B. Dwork
\end{center}

\lhead[\thepage]{\textit{A Deformation Theory for Singular Hyper-surfaces}}
\rhead[\textit{B. Dwork}]{\thepage}
...
\medskip
\noindent
{\bf Method \thnum{1}.\label{art07-method1}}
...
\medskip
\noindent
{\bf Method \thnum{2}.\label{art07-method2}}
