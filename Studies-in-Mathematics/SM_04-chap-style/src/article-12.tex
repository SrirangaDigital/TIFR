\chapter[\textsc{J-I. Igusa~:} Geometric and Analytic Methods in the Theory of Theta-Functions]{GEOMETRIC AND ANALYTIC METHODS IN THE THEORY OF THETA-FUNCTIONS$^{*}$}\label{art12}
\footnotetext[1]{This work was partially supported by the National Science Foundation.}

\begin{center}
By~~ Jun-Ichi Igusa
\end{center}

\lhead[\thepage]{\textit{Geometric and Analytic Methods in the Theory...}}
\rhead[\textit{J-I. Igusa}]{\thepage}
