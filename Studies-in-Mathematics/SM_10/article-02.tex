\chapter[PERIOD INTEGRALS OF COHOMOLOGY CLASSES\break WHICH ARE REPRESENTED BY EISENSTEIN SERIES]{PERIOD INTEGRALS OF COHOMOLOGY CLASSES WHICH ARE REPRESENTED BY EISENSTEIN SERIES}

\begin{center}
{\large By~ G. Harder}
\end{center}

\markboth{\textit{G. Harder}}{\textit{Period Integrals of Cohomology Classes...}}
