\chapter[EISENSTEIN SERIES AND THE RIEMANN\hfill\break ZETA-FUNCTION]{EISENSTEIN SERIES AND THE RIEMANN ZETA-FUNCTION}
...
\markboth{\textit{D. Zagier}}{\textit{Eisenstein Series and the Riemann Zeta-Function}}
...
\begin{equation*}
\zeta (2s) E (z,s) = \frac{1}{2} \sum\limits_{m,n}' \frac{y^2}{|mz+n|^{2s}}, \tag{2} \label{art10-eq2}
\end{equation*}
...
\bibitem[3]{art10-3} \textsc{Jacquet, H.}\pageoriginale and \textsc{J. Shalika},: A non-vanishing theorem for zeta functions of $GL_2$. \textit{Invent. Math.} 38 (1976) 1-16.
