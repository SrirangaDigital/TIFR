...
\section{The Hecke operators \texorpdfstring{$T_{n}$}{Tn}}\label{art10-sec5}
...
For the proof we require the following Lemma, which we quote from Theorem 5.2.1 of \cite{art10-key9}.
...
\section{The operators \texorpdfstring{$T^{*}_{p}T_{p}$}{TpTp} and \texorpdfstring{$T_{p}T^{*}_{p}(p|N)$}{TpTppN}}\label{art10-sec8}
~
...
\medskip
\noindent
{\bf Theorem \thnum{8.4}.\label{art10-thm8.4}}~{\em Let $f\in M(N,k,\chi)$ and suppose that $p|N$. Then}
\begin{equation}
...
\medskip
\noindent
{\bf Corollary \thnum{8.5}.\label{art10-coro8.5}}~{\em Suppose\pageoriginale that $f\in M^{+}$ and that, for some $p|N$ we have $p|n(\chi)$. Then, in the notation of Lemma \ref{art10-lem8.2},}
$$
...
\bibitem{art10-key1} \textsc{A.O.L. Atkin} and \textsc{J. Lehner :} Hecke operators on $\Gamma_{0}(m)$, {\em Math, Ann.} 185 (1969), 134-160.

\bibitem{art10-key2} \textsc{F.R. Gantmacher :} {\em Matrix theory}, vol. 1. Chelsea, 1960.

\bibitem{art10-key3} \textsc{E. Hecke :} Ueber Modulfunktionen und die Dirichletschen Reihen mit Eulerscher Produktentwicklung I, {\em Math. Ann.} 144(1937), 1-28 {\em Math. Ann.} 114(1937), 316-351.

\bibitem{art10-key4} \textsc{W.C.W. Li :} Newforms and functional equations, {\em Math. Ann.} 212 (1975), 285-315.

\bibitem{art10-key5} \textsc{W.C.W. Li :} Diagonalizing modular forms, {\em J. Algebra} 99(1986), 210-231.

\bibitem{art10-key6} \textsc{A.P. Ogg :} On the eigenvalues of Hecke operators, {\em Math. Ann.} 179 (1969). 101-108.

\bibitem{art10-key7} \textsc{H. Petersson :} Ueber eine Metrisierung der ganzen Modulformen, {\em Jber, Deutsch. Math. Verein.} 49(1939), 49-75.

\bibitem{art10-key8} \textsc{H. Petersson :} Konstruktion der samtlichen L\"osungen einer Riemannschen Funktionalgleichung durch Dirichlet-Reihen mit Eulerscher Produktentwicklung II, {\em Math. Ann.} 166 (1939), 39-64.

\bibitem{art10-key9} \textsc{R.A. Rankin :} {\em Modular forms and functions,} Cambridge University Press 1977.

\bibitem{art10-key10} \textsc{R. A. Rankin :} The adjoint Hecke operator I, J. {\em Madras University} (to appear).
\end{thebibliography}
