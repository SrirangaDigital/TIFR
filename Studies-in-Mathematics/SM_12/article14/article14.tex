...
We re-arrange the elements $b_{i}$ with $i\in T_{2}$ as
$$
...
Now, we are ready to apply lemma 2 of \cite{art14-key24} in the same way as in the proof of lemma 6 of \cite{art14-key24}. We apply this lemma with $n=2$, $A_{1}=k^{33}$, $A=(m+(k-1)d)^{1/t}$, $\tau_{1}=C_{24}$, $\tau_{2}=C_{25}$ and $u=C_{23}$ to the linear form \eqref{art14-eq34}. Then, we observe that the right hand side of inequality \eqref{art14-eq5} of this lemma exceeds
$$
...
\bibitem{art14-key1} \textsc{A. Baker :} Rational approximations to $\sqrt[3]{2}$ and other algebraic numbers, {\em Quart. J. Math.} Oxford (2) 15 (1964), 375-383.

\bibitem{art14-key2} \textsc{A. Baker :}\pageoriginale Contributions to the theory of Diophantine equations I : On the representation of integers by binary forms, {\em Philos. Trans. Roy. Soc. London.} Ser. A 263 (1968), 173-208.

\bibitem{art14-key3} \textsc{A. Baker :} The theory of linear forms in logarithms, {\em Transcendence Theory : Advances and Applications} (Academic Press 1977), 1-27.

\bibitem{art14-key4} \textsc{R. Balasubramanian} and \textsc{T. N. Shorey :} On the equation $a(x^{m}-1)/(x-1)=b(y^{n}-1)/(y-1)$, {\em Math. Scand.} 46 (1980), 177-182.

\bibitem{art14-key5} \textsc{J. H. E. Cohn :} On square Fibonacci numbers, {\em Jour. London Math. Soc.} 39 (1964), 537-540.

\bibitem{art14-key6} \textsc{H. Davenport, D. J. Lewis} and \textsc{A. Schinzel :} Equations of the form $f(x)=g(y)$, {\em Quart. J. Math.} 12(1961), 304-312.

\bibitem{art14-key7} \textsc{P. Erd\"os :} Note on the product of consecutive integers, {\em J. London Math. Soc.} 14 (1939), 245-249.

\bibitem{art14-key8} \textsc{P. Erd\"os :} On the product of consecutive integers (III), {\em Indag. Math.} 17 (1955), 85-90.

\bibitem{art14-key9} \textsc{P. Erd\"os} and \textsc{J. L. Selfridge :} The product of consecutive integers is never a power, {\em Illinois J. Math.} 19 (1975), 292-301. 

\bibitem{art14-key10} \textsc{P. Erd\"os} and \textsc{J. Turk :} Products of integers in short intervals, {\em Acta Arith.} 44 (1984), 147-174.

\bibitem{art14-key11} \textsc{R. Goormaghtigh :} {\em L'Interm\'ediaire des Math\'ematiciens,} 24 (1917), 88.

\bibitem{art14-key12} \textsc{H. London} and \textsc{R. Finkelstein :} On Fibonacci and Lucas numbers which are perfect powers, {\em Fibonacci Quart.} 7 (1969), 476-481.

\bibitem{art14-key13} \textsc{J. H. Loxton :} Some problems involving powers of integers, {\em Acta Arith.} 46 (1986), 113-123.

\bibitem{art14-key14} \textsc{A. Makowski} and \textsc{A. Schinzel :} Surl' \'equation ind\'eterminee de R. Goormaghtigh, {\em Mathesis} 68 (1958), 128-142.

\bibitem{art14-key15} \textsc{R. Marszalek :} On the product of consecutive elements of an arithmetic progression, {\em Monatsh. f\"ur. Math.} 100 (1985), 215-222.

\bibitem{art14-key16} \textsc{M. Ram Murty,\pageoriginale V. Kumar Murty} and \textsc{T. N. Shorey :} Odd values of Ramanujan $\tau$-function, {\em Bull. Soc. Math. France} 115 (1987), 391-395.

\bibitem{art14-key17} \textsc{T. Nagell :} The diophantine equation $x^{2}+7=2^{n}$, {\em Ark. Math. 4} (1961), 185-187.

\bibitem{art14-key18} \textsc{A. Peth\"o :} Perfect powers in second order linear recurrences, {\em Jour. Number Th.} 15 (1982), 5-13.

\bibitem{art14-key19} \textsc{S. Ramanujan :} Question 464, {\em Jour. Indian Math. Soc.} 5(1913), 120, {\em Collected Papers,} Cambridge University Press (1927), 327.

\bibitem{art14-key20} \textsc{R. Ratat :} {\em L'Intermediaire des Math\'ematiciens} 23 (1916), 150.

\bibitem{art14-key21} \textsc{O. Rigge :} Uber ein Diophantisches Problem, {\em 9th Congress Math. Scand.,} Helsingfors, 1938, Mercator, Helsingfors, 1939, 155-160.

\bibitem{art14-key22} \textsc{A. Schinzel} and \textsc{R. Tijdeman :}  On the equation $y^{m}=P(x)$, {\em Acta Arith.} 31 (1976), 199-204.

\bibitem{art14-key23} \textsc{T. N. Shorey :} On the equation $a(x^{m}-1)/(x-1)=b(y^{n}-1)/(y-1)$ (II), {\em Hardy-Ramanujan Jour.} 7 (1984), 1-10.

\bibitem{art14-key24} \textsc{T. N. Shorey :} Perfect powers in values of certain polynomials at integer points, {\em Math. Proc. Cambridge Phil. Soc.} 99 (1986), 195-207.

\bibitem{art14-key25} \textsc{T. N. Shorey :} On the equation $z^{q}=(x^{n}-1)/(x-1)$, {\em Indag. Math.} 48 (1986), 345-351.

\bibitem{art14-key26} \textsc{T. N. Shorey :} On the equation $ax^{m}-by^{n}-k$, {\em Indag. Math.} 48 (1986), 353-358.

\bibitem{art14-key27} \textsc{T. N. Shorey :} Some exponential Diophantine equations, {\em New advances in transcendence Theory}, ed. by A. Baker, Cambridge University Press, to appear.

\bibitem{art14-key28} \textsc{T. N. Shorey :} Ramanujan and Binary recursive sequences, {\em Jour. Indian Math. Soc.} 51 (1987), 147-157.

\bibitem{art14-key29} \textsc{T. N. Shorey :} Integers with identical digits, {\em Acta Arith.,} to appear.

\bibitem{art14-key30} \textsc{T. N. Shorey}\pageoriginale and \textsc{C. L. Stewart :} On the diophantine equation $ax^{2t}+bx^{t}y+cy^{2}=d$ and pure powers in recurrence sequences, {\em Math. Scand.} 52 (1983), 24-36.

\bibitem{art14-key31} \textsc{T. N. Shorey} and \textsc{C. L. Stewart :} Pure powers in recurrence sequences and some related diophantine equations, {\em Jour. Number Th.} 27 (1987), 324-352.

\bibitem{art14-key32} \textsc{T. N. Shorey} and \textsc{R. Tijdeman :} New applications of Diophantine approximations to Diophantine equations, {\em Math. Scand.} 39 (1976), 5-18.

\bibitem{art14-key33} \textsc{T. N. Shorey} and \textsc{R. Tijdeman :} {\em Exponential Diophantine Equations,} Cambridge Tracts in Mathematics 87 (1986), Cambridge University Press.

\bibitem{art14-key34} \textsc{T. N. Shorey} and \textsc{R. Tijdeman :} On the greatest prime factor of an arithmetical progression, to appear.

\bibitem{art14-key35} \textsc{T. N. Shorey} and \textsc{R. Tijdeman :} Perfect powers in products of terms in an arithmetical progression, to appear.

\bibitem{art14-key36} \textsc{A. Thue :} Uber Ann\"aherungswerte algebraischer Zahlen, {\em J. Reine Angew. Math.} 135 (1909), 284-305.

\bibitem{art14-key37} \textsc{O. Wyler :} Squares in the Fibonacci series, {\em Amer. Math. Monthly} 71 (1964), 220-222.
