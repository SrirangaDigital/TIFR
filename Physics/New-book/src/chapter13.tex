\chapter[Lecture 13]{}\label{lec13}
...
\begin{proof}
\fbox{$e^{i\overrightarrow{k}\cdot \overrightarrow{R}}=1$} 
...
\end{align*}
For a particular plane \fbox{$\overrightarrow{k}\cdot \overrightarrow{r}=A\to$} by definition.
