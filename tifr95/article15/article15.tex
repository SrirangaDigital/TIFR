...
\medskip
\noindent
{\bfseries Lemma \thnum{3.} \label{art15-lemma-3}} \textit{For any $X \in \fg^{\bC}$ and $g =n_{z}n_{w}^{-}t \in G \cap N B$, using the above notation, we have}
$$
...
\medskip
\noindent
{\bfseries Lemma \thnum{4.} \label{art15-lemma-4}} \textit{For any $X \in \fg$ and $g', g'' \in GB$,}
\begin{equation*}
\begin{split}
...
\medskip
\noindent
{\bfseries Remark \thnum{2.} \label{art15-remark-2}} In case that $G$ is compact,the theorem is valid for any $Y \in \fg^{\bC}$, because Lemma \ref{art15-lemma-4} holds for any $X\in \fg^{\bC}$  in this case.

\begin{thebibliography}{99}
\bibitem{art15-key1} R. Bott, \textit{Homogeneous vector bundles}, Ann. of Math. {\bf 66} (1957) 203-248.
\bibitem{art15-key2} Harish-Chandra, \textit{Representaions of semisimple Lie groups IV}, Amer. Math. J. {\bf 77} (1955) 742-777.
\bibitem{art15-key3} Harish-Chandra, \textit{Representations of semisimple Lie groups V}, Amer. Math. J. {\bf 78} (1956) 1-41.
\bibitem{art15-key4} Harish-Chandra, \textit{Representations of semisimple Lie groups VI}, Amer. Math. J. {\bf 78} (1956) 564-628.
\bibitem{art15-key5} T. Hashimoto, K.Ogura, K.Okamoto, R.Sawae and H. Yasunaga, \textit{Kirillov-Kostant theory and Feynman path integrals on coadjoint orbits I}, Hokkaido Math. J. {\bf 20}(1991) 353-405.
\bibitem{art15-key6} T.Hashimoto, K.Ogura, K.Okamoto, R.Sawae, \textit{Kirillov-Kostant theory and Feynman path integrals on coadjoint orbits of $SU(2)$ and $SU(1,1)$,} to appear in Proceedings of the RIMS Research Project 91 on Infinit Analysis.
\bibitem{art15-key7}T.Hashimoto, K.Ogura, K.Okamoto, R.Sawae,\textit{Borel-Weil theory and Feynman path integrals on flag manifolds}, Hiroshima Math. J. (to appear). 
\bibitem{art15-key8} B.Kostant, \textit{Lie algebra cohimology and the generalized Borel-Weil theorem}, Ann. of Math.
{\bf 74} (1961) 329-387.
\bibitem{art15-key9} M.S. Narasimhan  and K. Okamoto,\textit{An analogue of the Borel-Weil-Bott theorem for hermitian symmetric pairs of non-compact type}, Ann. of Math. {\bf 91} (1970) 486-511.
\bibitem{art15-key10} A. Pressley and G. Segal, Loop Groups, Clarendon Press, Oxford, 1986.
\bibitem{art15-key11}H. Yasunaga, \textit{Kirillov-Kostant theory and Feynman path integrals on coadjoint orbits II}, Hiroshima Math. J. (to appear).
\end{thebibliography}
