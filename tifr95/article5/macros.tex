...
\newtheorem{theorem}[prop]{Theorem}%%%%art5%%%%%%%
\newtheorem{main theorem}[prop]{Main Theorem}%%%%art5%%%%%%%
...
\newtheorem{definition}[prop]{Definition}%%%%%art5%%
\newtheorem{example}[prop]{Example}%%%%%%art5%%%
\newtheorem{criterion}[prop]{Criterion}%%%%%%art5%%%
\newtheorem{conjecture}[prop]{Conjecture}%%%%%%art5%%%
\newtheorem{remark}[prop]{Remark}%%%%%%art5%%%
