...
A proof is given in Chapter VIII of Raghunathan (\cite{art9-raghunathan-1}, Corollary 8.28).
...
\begin{romantheorem}{\rm (Mahler's criterion).}\label{art9-romanthm7}
Let 
$$
...
\section{$L$-subgroups of rank $\geqslant 2$.}\label{art9-sec4}
...
{
\tabcolsep=3pt
\setcounter{table}{0}\pageoriginale
\begin{longtable}{@{}|c|c|c|@{}}
\caption{}\\
\hline
Type of $G$ & Extended diagram of $\Delta$ & $\Delta'$\\\hline
$A_n$ & \begin{tabular}{c}{\includegraphics[scale=0.75]{305a.eps}}\end{tabular}
& $\{\alpha_i\} 2 i \neq  n +1$ \\\hline
$A_n \times A_n$  & \begin{tabular}{c}{\includegraphics[scale=0.8]{305b.eps}}\\{\includegraphics[scale=0.8]{305c.eps}}\end{tabular} & \begin{tabular}{c}
...
$D_n, n$ odd\\[0.1cm]
$n > 3$
\end{tabular}  & \begin{tabular}{c}{\includegraphics[scale=0.8]{305d.eps}}\end{tabular}  & $\{\alpha_{n-1}\}$ or $\{\alpha_n\}$\\\hline
\begin{tabular}{c}
$D_n \times D_n$\\[0.3cm]
$n$ odd \\[0.3cm]
$n > 3$
...
\subsection{}\label{art9-subsec5.20}\pageoriginale
~
...
\bibitem{art9-auslander-1} \textsc{L. Auslander : [1]} Bieberbach's\pageoriginale theorem on space groups and discrete uniform subgroups, \textit{Ann. of Math.} 71 (1960), 579-590 II, \textit{Amer. J. Math.,} 86 (1961), 276-280.

\bibitem{art9-borel-1} \textsc{A. Borel : [1]} Density properties of certain subgroups of semisimple groups, \textit{Ann. of Math.,} 72 (1960), 179-188.

\bibitem{art9-borel-2} \textsc{A. Borel : [2]} Sousgroupes discrets de groupes semisimple, \textit{Seminaire Bourbaki} (1968-69), \textit{Expose} 358.

\bibitem{art9-borel-3} \textsc{A. Borel : [3]} \textit{Linear algebraic groups,} Benjamin, New York, (1969).

\bibitem{art9-borel-tits-1} \textsc{A. Borel,} and \textsc{J. Tits:} [1] Groupes reductifs, \textit{Publ. Mathematiques, I.H.E.S.,} 27 (1965), 55-150.

\bibitem{art9-borel-tits-2} \textsc{A. Borel,} and \textsc{J. Tits:} [2] \'El\'ements unipotents et sous-groupes paraboliques de groups r\'eductifs. I., \textit{Inv. Math.,} 12 (1971), 95-104.

\bibitem{art9-garland-raghunathan-1} \textsc{H. Garland} and \textsc{M. S. Raghunathan : [1]} Fundamental domains for lattices in ($R$-) rank 1 semisimple Lie groups, \textit{Ann. of Math.,} 92 (1970), 279-326.

\bibitem{art9-kazdan-margolis-1} \textsc{D. A. Kazdan} and \textsc{G. A. Margolis :} [1] A proof of Selberg's, hypothesis, \textit{Math. Sbornik (N. S.)}, 75 (117)  (1968), 162-168 (Russian).

\bibitem{art9-malcev-1} \textsc{A. I. Mal'cev :} [1] On a class of homogeneous spaces, \textit{Amer. Math. Soc. Transl. No.} 39 (1951).

\bibitem{art9-margolis-1} \textsc{G. A. Margolis :} [1] On arithmeticity of discrete groups, \textit{Soviet. Math. Dokl., } 10 (1969), 900-902 (Russian).

\bibitem{art9-margolis-2} \textsc{G. A. Margolis :} [2] On the action of unipotent groups in the space of lattices, \textit{Math. Sb,} 86 (1969), 552 (Russian).

\bibitem{art9-mostow-1} \textsc{G. D. Mostow : [1]} On maximal subgroups of real Lie groups. \textit{Ann. of Math., } 74 (1961), 503-517.

\bibitem{art9-pjatetski-1} \textsc{I. I. Pjatets$\check{\textsc{k}}\check{\textsc{i}}$-Shapiro} : [1] Discrete subgroups of Lie groups. \textit{Trudy Moskov. Mat. Obsc.,} 18 (1968) , 3-18.

\bibitem{art9-raghunathan-1} \textsc{M. S. Raghunathan :} [1] \textit{Discrete subgroups of Lie groups,} Springer-Verlag, New York (1972).

\bibitem{art9-raghunathan-2} \textsc{M. S. Raghunathan :} [2] Cohomology of arithmetic subgroups of algebraic groups, I., \textit{Ann. of Math.} 86 (1967), 409-424.

\bibitem{art9-raghunathan-3} \textsc{M. S. Raghunathan :} [3] A note on\pageoriginale quotients of real algebraic groups by arithmetic subgroups, \textit{Inv. Math.}

\bibitem{art9-raghunathan-4} \textsc{M. S. Raghunathan :} [4] Lattices in semisimple Lie groups, \textit{Actes du Congr\`es International des math\'ematiciens} (Nice 1970), 2, 337-341, Gautier-Villars, Paris (1971).

\bibitem{art9-rosenlicht-1} \textsc{M. Rosenlicht:} [1] Some rationality questions on algebraic groups, \textit{Ann. di. Math.,} 43 (1957),  25-50.

\bibitem{art9-rosenlicht-2} \textsc{M. Rosenlicht:} [2] On quotient varieties and affine embedding of certain homogeneous spaces, \textit{Trans. Amer. Math. Soc.,} 101 (1961), 211-233.

\bibitem{art9-tits-1} \textsc{J. Tits : } [1] Classification of semisimple algebraic groups, algebraic groups and discontinuous groups, \textit{A. M. S., Proceedings of Symposia in Pure Mathematics,} IX.

\bibitem{art9-wang-1} \textsc{H. C. Wang :} [1] On the deformation of lattices in a Lie group, \textit{Amer. J. Math., 91 (1967), 921-937}.

\bibitem{art9-zassenhaus-1} \textsc{H. Zassenhaus : } [1] Beweis eines Satzes uber diskrete Gruppen, \textit{Abh. Math. Sem. Hansisch. Univ.,} 12 (1938), 289-312.
\end{thebibliography}
