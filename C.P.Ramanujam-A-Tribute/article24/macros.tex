...
\newtheorem{subprop}[theorem]{Proposition}
\newtheorem{subdefin}{theorem}[subsection]
...
\newtheorem{case}{Case}
\newtheorem{subremark}[theorem]{Remark}
...
\def\hleftarrow{\raisebox{6pt}{\rotatebox{180}{$\xhookrightarrow{\quad}$}}}
\def\hrightarrow{\raisebox{6pt}{\rotatebox{180}{$\xhookleftarrow{\quad}$}}}
...
\theoremstyle{alphprop}
\newtheorem{alphprop}{Proposition}
\renewcommand{\thealphprop}{\Alph{alphprop}}


\newtheoremstyle{mystyle}{}{}{\itshape}{}{\bfseries}{$'$.}{ }{}
\theoremstyle{mystyle}
\newtheorem{dashlemma}{Lemma}
\renewcommand{\thedashlemma}{\Alph{dashlemma}}
