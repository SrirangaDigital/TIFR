...
\bibitem{art16-key-B} \textsc{A. Borel :} Groupes lin\'earies alg\'ebriques, {\em Ann. of Math.} 64 (1956), 20-82,

\bibitem{art16-key-F} \textsc{A. Weil :} {\em Foundations of algebraic geometry}, Amer. Math. Soc. Coll. Publ. (1946).

\bibitem{art16-key-K} \textsc{T. Kambayashi :} Projective representation of algebraic linear groups of transformations, {\em Amer. J. Math.} 88 (1966), 199-205.

\bibitem{art16-key-L} \textsc{M. Nagata :} {\em Local rings,} John Wiley (1962).
\end{thebibliography}
