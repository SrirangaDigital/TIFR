...
\end{equation}
where $\zeta_{2}=0$ is a suitable local equation for $K$ and $\zeta_{1}=0$ for the line passing through the point and along which $V^{(2)}_{a}$ is branched over $W$.\pageoriginale %page 235
