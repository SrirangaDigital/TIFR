...
\newcommand{\pageoriginale}{\stepcounter{pageoriginal}\marginpar{\footnotesize\xspace\textbf{\thepageoriginal}}} 
...
\def\@makechapterhead#1{%
  ...
  {\parindent \z@ \raggedright \normalfont
    \ifnum \c@secnumdepth >\m@ne
      \if@mainmatter
      {\huge\bfseries Part~\MakeUppercase{\romannumeral\thechapter}}
      \vskip 10pt
        \par\nobreak
      \fi
    \fi
